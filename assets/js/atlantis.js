...
$('#show-signup').on('click', function () {
	document.title = "Sindycart - Daftar";
	showSignUp = true;
	showSignIn = false;
	changeContainer();
})
...
$('#show-signin').on('click', function () {
	document.title = "Sindycart - Login";
	showSignUp = false;
	showSignIn = true;
	changeContainer();
})
...
// index ~ profile
var containerInd = $('.container-index'),
	containerPro = $('.container-profile'),
	showIndex = true,
	showProfile = false;

function changeContainerIndex() {
	if (showIndex == true) {
		containerInd.css('display', 'block');
	} else {
		containerInd.css('display', 'none')
	}

	if (showProfile == true) {
		containerPro.css('display', 'block')
	} else {
		containerPro.css('display', 'none')
	}
}

$('.show_profile').on('click', function () {
	$('.btn.btn-xs.btn-secondary.btn-sm.show_profile').toggleClass('d-none');
	showProfile = true;
	showIndex = false;
	changeContainerIndex();
})

$('.show_index').on('click', function () {
	showProfile = false;
	showIndex = true;
	changeContainerIndex();
})
