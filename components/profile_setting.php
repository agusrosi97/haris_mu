                    ...
                    <div class="col-md-3">
                      <div class="col d-flex justify-content-center mb-4 text-center">
                        <div class="input-file input-file-image">
                          <img class="img-upload-preview" width="150" src="<?= $row['foto_customer'] == "" ? "https://via.placeholder.com/150" : "assets/upload_image/" . $row['foto_customer']; ?>" alt="preview">
                          <input type="file" class="form-control form-control-file" id="uploadImg2" name="foto_customer" accept="image/*">
                          <label for="uploadImg2" class="label-input-file btn btn-black btn-round">
                            <span class="btn-label">
                              <i class="fa fa-file-image"></i>
                            </span>
                            <?= $row['foto_customer'] == "" ? "Upload Foto" : "Ganti Foto"; ?>
                          </label>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="row">
                        <div class="col-md-7 mb-3">
                          <div class="form-group form-group-default">
                            ...
                            <input type="text" class="form-control prf" name="nama_customer" placeholder="Nama Anda" value="<?= $row['nama_customer'] ?>">
                          </div>
                        </div>
                        <div class="col-md-5 mb-2">
                          <div class="form-group form-group-default">
                            <label>Username</label>
                            <input type="text" class="form-control prf" name="username_user" placeholder="Username Anda" value="<?= $row['username_customer'] ?>" id="input_username">
                          </div>
                          <div class="mt-n3 pl-3 d-none font-weight-bold text-danger" style="font-size: 79% !important;" id="user-ada"></div>
                        </div>
                        <div class="col-md-7 mb-2">
                          <div class="form-group form-group-default">
                            <label>Email</label>
                            <input type="email" class="form-control prf" name="email_customer" placeholder="Email Anda" value="<?= $row['email_customer'] ?>" readonly>
                          </div>
                        </div>
                        <div class="col-md-5 mb-2">
                          <div class="form-group form-group-default">
                            <label>Tanggal Lahir</label>
                            <?php $tgl = date_format(new Datetime($row['dob_customer']), "d-m-Y") ?>
                            <input type="text" class="form-control prf" id="datepicker" name="dob_customer" value="<?= $tgl ?>" placeholder="Tanggal lahir" readonly>
                          </div>
                        </div>
                        <div class="col-md-5 mb-2">
                          <div class="form-group form-group-default">
                            <label>Nomor Telepon</label>
                            <input type="text" class="form-control prf" value="<?= $row['notelp_customer'] ?>" name="notelp_customer" placeholder="Nomor telepon Anda">
                          </div>
                        </div>
                        <div class="col-md-4 mb-2">
                          <div class="form-group form-group-default mb-4">
                            <label>Jenis Kelamin</label>
                            <select class="sel1 form-control" id="gender" data-container="body" title="Jenis Kelamin" name="jk_customer">
                              <option value="">Pilih</option>
                              <option value="L" <?= $row['jk_customer'] == 'L' ? "selected" : ""; ?>>Laki-laki</option>
                              <option value="P" <?= $row['jk_customer'] == 'P' ? "selected" : ""; ?>>Perempuan</option>
                            </select>
                          </div>
                        </div>
                        <div class="col-md-12 mb-2">
                          <div class="form-group form-group-default">
                            <label>Alamat</label>
                            <textarea class="form-control prf" name="alamat_customer" placeholder="Alamat Anda"><?= $row['alamat_customer'] ?></textarea>
                          </div>
                        </div>
                      </div>
